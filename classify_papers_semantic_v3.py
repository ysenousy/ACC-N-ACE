...
Keywords: Natural Language Processing, NLP, multimodal extraction, document AI, OCR, table extraction, diagram understanding, layout analysis, visual document parsing, doc-understanding models, PDF to structured, document layout modeling, semantic parsing, rule mining from tables, multimodal NLP, vision language models, image text alignment, semantic segmentation, CV fusion.
""",

    "Semantic Alignment with BIM/IFC": """
Establishing clear and computable links between regulatory requirements and IFC based BIM data by aligning rules with specific entities, properties, and relationships, enabling accurate querying and automated compliance checking through schema mapping and BIM aware rule execution.
Keywords: semantic alignment, IFC mapping, rule to model alignment, entity and property mapping, property set alignment, BIMQL queries, constraint to IFC property mapping, rule to BIM binding, BPMN and DMN with BIM, SHACL, SPARQL, compliance oriented object model, IFC schema extension, spatial structure and topology, traceability to model elements, model checking.
""",
...
Keywords: large language models, LLM, GPT, BERT, ChatGPT, retrieval augmented generation, RAG, RAG-graph, neural-symbolic, prompt engineering, few shot learning, one shot learning, compliance automation, text-to-rule generation, deep learning, semantic retrieval, vector embedding, compliance AI pipeline, fine-tuned transformer, domain adaptation, hybrid AI frameworks.
""",

    "Explainability and Trust in AI Systems": """
Building compliance checking systems in a way that offer interpretable, user understandable outputs to help develop trust with the practitioners, auditors, and regulators. This involves application of visual logic models, transparent rule structures, and intuitive representations that allow users to trace rule decisions back to source regulations.
Keywords: explainable compliance, tree based visualization, user understandable logic, interpretable rules, regulatory traceability, transparent reasoning, compliance explainability, trust in AI, AI-assisted decision-making, visual logic modeling, rule transparency, provenance, auditability.
""",
...
Keywords: benchmarking, evaluation metrics, performance assessment, comparative analysis, accuracy, precision, recall, F1-score, rule coverage, tool maturity, usability testing, adoption readiness, validation frameworks, evaluation criteria, compliance testing metrics, dataset, generalization metrics.
""",

    "Tool Development and Real-World Application": """
Designing, implementing, and validating practical systems for automated compliance checking (ACC) within real-world environments.
Keywords: compliance tool, BIM integration, IFC-based checking, domain-specific language, tool validation, automated BIM checking, knowledge-driven tool, generative design, workflow automation, pilot project, real-world implementation, case study evaluation, lifecycle, UI, adoption.
"""
}
